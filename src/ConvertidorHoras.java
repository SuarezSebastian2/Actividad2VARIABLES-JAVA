 ...
 * @author SEBASTIAN
 */
public class ConvertidorHoras extends javax.swing.JFrame {

    /**
     * Creates new form ConvertidorHoras
     */
    public ConvertidorHoras() {
        initComponents();
        setLocationRelativeTo(null);

        SpinnerNumberModel nm = new SpinnerNumberModel();
        nm.setMinimum(0);
        Contador.setModel(nm);
    }
    ...
    private void initComponents() {
        ...
        Contador.setModel(new javax.swing.SpinnerNumberModel(0, 0, null, 1));
        ...
        Calcular.setFont(new java.awt.Font("Segoe UI", 3, 16)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(Contador, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void CalcularMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CalcularMouseClicked
        ...
        int contador, horas, minutos, segundos;
        contador = (int) Contador.getValue();
        horas = contador * 24;
        minutos = contador * (60 * 24);
        segundos = contador * (3600 * 24);
        
        Horas.setText("" + horas);
        Minutos.setText("" + minutos);
        Segundos.setText("" + segundos);
        
        Resultado.setText(contador+" dias tienen "+ horas+" horas = "+minutos+" minutos = "+segundos+" segundos ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConvertidorHoras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConvertidorHoras().setVisible(true);
            }
        });
    }
